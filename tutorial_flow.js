    ...
    return {
      movement_tutorial: {
        ...
        anchors: {
          ...
          dashLand: { x: 420, y: groundY - 48 },
          switchZone: { x: 446, y: groundY },
        },
        layout: {
          surfaces: [
            { id: "tutorial-ground-a", x: world.left, y: groundY, w: 164 },
            { id: "tutorial-jump-platform", x: 228, y: groundY - 62, w: 96 },
            { id: "tutorial-dash-platform", x: 388, y: groundY - 48, w: 96 },
            { id: "tutorial-exit-walkway", x: 484, y: groundY - 48, w: width - 484 - world.left },
          ],
          solidBlocks: [
            { id: "tutorial-jump-block", x: 228, y: groundY - 62, w: 96, h: 62 },
            { id: "tutorial-dash-block", x: 388, y: groundY - 48, w: 96, h: 48 },
          ],
          spikePit: { x: 324, y: groundY - 20, w: 56, h: 20 },
          switchPedestal: { x: 446, y: groundY - 76, w: 18, h: 28 },
        },
      },
      melee_tutorial: {
        id: "melee_tutorial",
